...
* Changed: Menu WordPress e admin bar - titolo "FP SEO Manager" (allineamento con nome plugin e cartella)
...
* Added: Campo "Contesto sito" in Settings > AI per migliorare i risultati generazione
...
* Added: Redirect Manager (301/302) with bulk CSV import
* Added: New admin menu "Redirect Manager" under SEO Performance
