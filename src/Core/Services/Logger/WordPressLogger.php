 ...
 *
 * @package FP\SEO\Core\Services\Logger
...
namespace FP\SEO\Core\Services\Logger;
 ...
 * WordPress logger implementation.
 *
 * Implements LoggerInterface and provides structured logging capabilities.
 */
class WordPressLogger implements LoggerInterface {
	...
	/**
	 * Check if logging is enabled (cached for performance).
	 *
	 * @var bool|null
	 */
	private static ?bool $logging_enabled = null;
	...
	public function log( string $level, string $message, array $context = array() ): void {
		// Early return if logging is disabled (cached check for performance)
