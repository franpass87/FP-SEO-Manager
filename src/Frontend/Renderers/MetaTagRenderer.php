 ...
 */
class MetaTagRenderer extends AbstractRenderer implements RendererInterface {
	...
	public function register(): void {
		$this->add_action( 'wp_head', array( $this, 'render_meta_tags' ), 0 );
		// Filter document title to use SEO title if different from post title
		$this->add_filter( 'pre_get_document_title', array( $this, 'filter_document_title' ), 10, 1 );
		$this->add_filter( 'document_title_parts', array( $this, 'filter_document_title_parts' ), 10, 1 );
	}
	...
	public function should_render( $context = null ): bool {
		return ! is_admin() && ! is_feed() && ! is_preview() && is_singular();
	}
