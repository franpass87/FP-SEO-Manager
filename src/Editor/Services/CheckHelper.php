<?php
/**
 * Helper class for SEO check information.
 *
...
/**
 * Provides helper methods for SEO check information.
 */
class CheckHelper {

	/**
	 * Get check importance level.
	 *
	 * @param string $check_id Check ID.
	 * @return string Importance level description.
	 */
