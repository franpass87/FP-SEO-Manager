...
use FP\SEO\Admin\Renderers\BulkAuditPageRenderer;
use FP\SEO\Admin\Styles\BulkAuditStylesManager;
 ...
 */
class BulkAuditPage {
	public const PAGE_SLUG     = 'fp-seo-performance-bulk';
	...
	/**
	 * @var BulkAuditStylesManager|null
	 */
	private $styles_manager;

	/**
	 * @var BulkAuditPageRenderer|null
	 */
	private $renderer;
	...
	public function register(): void {
		...
		// Initialize renderer
		$this->renderer = new BulkAuditPageRenderer();
	}
