	...
	public function render( array $options ): void {
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="<?php echo esc_attr( $this->get_option_key() ); ?>[general][enable_analyzer]" value="1" <?php checked( $general['enable_analyzer'] ?? false ); ?> />
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="<?php echo esc_attr( $this->get_option_key() ); ?>[general][admin_bar_badge]" value="1" <?php checked( $general['admin_bar_badge'] ?? false ); ?> />
